...
const useNamesOfAllahStore = create<NamesOfAllahStore>((set) => ({
    namesOfAllah: [
        ...
        { id: 77, text: 'المجيد', color: '#f0f4c3', description: 'العظيم الذي لا يُشبهه شيءٌ من خلقه، وهو الذي له صفات العظمة والكبرياء.' },
        { id: 79, text: 'الشّهد', color: '#c5cae9', description: 'المُشاهد لكلّ شيءٍ، وهو الذي لا يخفى عليه شيءٌ من خلقه.' },
        { id: 81, text: 'الوكيل', color: '#ffe0b2', description: 'المُوكَّل بأمور عباده، وهو الذي يُدبّر شؤونهم.' },
        { id: 82, text: 'القوي', color: '#bbdefb', description: 'الذي لا يُشبهه شيءٌ من خلقه، وهو الذي له صفات العظمة والكبرياء.' },
        { id: 83, text: 'المتين', color: '#cfd8dc', description: 'المُتين الذي لا يُشبهه شيءٌ من خلقه، وهو الذي له صفات العظمة والكبرياء.' },
        { id: 84, text: 'الوليّ', color: '#ffe0b2', description: 'المُعين لعباده، وهو الذي يُساعدهم في كلّ ما يحتاجونه.' },
        { id: 86, text: 'المحصي', color: '#f8bbd0', description: 'المُحصي لأعمال عباده، وهو الذي يُحاسبهم على أعمالهم.' },
        { id: 87, text: 'المبدئ', color: '#c5cae9', description: 'المُبدِع لكلّ شيءٍ، وهو الذي يُنشئ الأشياء من العدم.' },
        { id: 89, text: 'المحيي', color: '#ffe0b2', description: 'المُحيي للموتى، وهو الذي يُعيدهم إلى الحياة بعد الموت.' },
        { id: 91, text: 'الحيّ', color: '#cfd8dc', description: 'الذي لا يموت، وهو الذي له صفات الحياة الأبدية.' },
        { id: 92, text: 'القيوم', color: '#ffe0b2', description: 'الذي يقوم على كلّ شيءٍ، وهو الذي يُدبّر شؤون عباده.' },
        { id: 93, text: 'الواجد', color: '#f0f4c3', description: 'الذي لا يُشبهه شيءٌ من خلقه، وهو الذي له صفات العظمة والكبرياء.' },
